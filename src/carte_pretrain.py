...
class CARTE_KGPretrain:
    ...
    def _load_graphlet_construction(self):
        ...
        self.gc_ = Graphlet(
            data_kg=data_yago, num_hops=self.num_hops, max_nodes=self.max_nodes
        )
        return None

    def _run_step(
        self, entity_idx, data, model_run_pretrain, optimizer, scheduler, step
    ):
    ...
    def _collate_batch(self, data):
        ...
        with torch.no_grad():
            data_batch = self.make_batch_.from_data_list(
